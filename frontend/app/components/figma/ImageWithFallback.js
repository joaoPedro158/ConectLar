const _jsxFileName = "srcdefinito/app/components/figma/ImageWithFallback.tsx"; function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } }import React, { useState } from 'react'
