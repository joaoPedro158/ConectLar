...
public interface TrabalhoJpaRepository extends JpaRepository<TrabalhoEntity, Long> {
  ...
  List<TrabalhoEntity> findByStatusNotInOrderByDataHoraAbertaDesc(List<StatusTrabalho> statusIgnorados);
  ...
  List<TrabalhoEntity> findAllByProfissionalId(Long idProfissional);
